...
class CurrentMachine extends Component {
  ...
  render () {
    const { machine, onHandleNameChange, onHandleMachineUpdate } = this.props
    return (
      <div>
        {this.props.machine &&
          <div className='flexer' style={{ padding: 20 }}>
            <div style={{ flex: 1 }}>
              ...
              >
                ...
                />
                <button className='update-machine-btn' type='submit'>SUBMIT</button>
              </form>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div>
                <h3>Stats</h3>
                <p>IP Address: <span>{machine.ip_address}</span></p>
              </div>
            </div>
